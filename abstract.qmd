...
Weiterhin möchten wir die Hypothese überprüfen, die eine kürzere Bearbeitungsdauer bei höherem KI-Vorwissen verspricht. Zwischen Vorerfahrung mit KI und durchschnittlicher Bearbeitungszeit besteht kein signifikanter Zusammenhang (*r*(167) = .05, *p* = .52). Das bedeutet, dass ein höheres KI-Vorwissen nicht mit einer kürzeren Bearbeitungsdauer einherging (@fig-corr).
