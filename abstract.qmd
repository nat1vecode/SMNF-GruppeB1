...
Die Bearbeitungszeit *time_on_task*, gemessen in Millisekunden, wird mit einem Mittelwert von *M* = 78.724.623 ms (*SD* = 39.515.139 ms, *Median* = 86.414.497 ms, *Min* = 306 ms, *Max* = 146.766.444 ms) beschrieben (\@tbl-metric). Um eine bessere Lesbarkeit zu gewährleisten, entspricht dies einer durchschnittlichen Bearbeitungszeit von etwa 78,7Sekunden (*SD* ≈ 39,5 Sekunden). Diese Variable wird später in der Korrelationsanalyse verwendet.
